...
- Name: demoprojectaddtocart.spec.js >> Add To Cart and Purchase Functionality >> TC07 - Select product and add to cart
- Location: tests\demoprojectaddtocart.spec.js:38:5
